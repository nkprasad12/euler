...
public class DivisorGeneratorTest {
  ...
  public void divisors_ofPrimeSquare_generatesExpected() {
    assertContainEqualElements(
        divisors(25, true, true).list(),
        Arrays.asList(1l, 5l, 25l));
  }

  @Test 
  public void properDivisors_ofPrimeSquare_generatesExpected() {
    assertContainEqualElements(
        divisors(25, true, false).list(),
        Arrays.asList(1l, 5l));
  }
  ...
  public void nonUnitDivisors_ofPrimeSquare_generatesExpected() {
    assertContainEqualElements(
        divisors(25, false, true).list(),
        Arrays.asList(5l, 25l));
  }

  @Test 
  public void properNonUnitDivisors_ofPrimeSquare_generatesExpected() {
    assertContainEqualElements(
        divisors(25, false, false).list(),
        Arrays.asList(5l));
  }
  ...
  public void divisors_ofComposite_generatesExpected() {
    assertContainEqualElements(
        divisors(12, true, true).list(),
        Arrays.asList(1l, 2l, 3l, 4l, 6l, 12l));
  }

  @Test 
  public void properDivisors_ofComposite_generatesExpected() {
    assertContainEqualElements(
        divisors(12, true, false).list(),
        Arrays.asList(1l, 2l, 3l, 4l, 6l));
  }

  @Test 
  public void nonUnitDivisors_ofComposite_generatesExpected() {
    assertContainEqualElements(
        divisors(12, false, true).list(),
        Arrays.asList(2l, 3l, 4l, 6l, 12l));
  }

  @Test 
  public void properNonUnitDivisors_ofComposite_generatesExpected() {
    assertContainEqualElements(
        divisors(12, false, false).list(),
        Arrays.asList(2l, 3l, 4l, 6l));
  }
  ...
  public void divisors_ofLargeComposite_generatesExpected() {
    assertContainEqualElements(
        ...
        Arrays.asList(
            1l, 2l, 3l, 6l, 13l, 26l, 39l, 78l, 317l, 634l,
            951l, 1902l, 4121l, 8242l, 12363l, 24726l));
  }

  private static GeneratorConsumer<Long> divisors(
      long n, boolean includeOne, boolean includeN) {
